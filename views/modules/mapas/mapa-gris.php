...
<head>
    ...
    <style>
        ...
        #map-container {
            width: 100vw; /* Cambia el ancho según tus necesidades */
            height: 100vh; /* Cambia la altura según tus necesidades */
        ...
        #map-image {
            ...
            top: 0; /* Colocar la imagen pegada arriba del contenedor */
...
<body>
    ...
    <div id="map-container">
        <!-- Imagen del mapa gris -->
        <img id="map-image" src="mapa_rei_gris.jpg" alt="Mapa Gris">
    </div>
