...
$usuariosdonpedrotortajada = $usuariosController->obtenerUsuariosPorCalleController("donpedrotortajada");
...
<head>
    <meta charset="UTF-8">
    <title>Carrer Don Pedro Tortajada</title>
...
<body>
    ...
    <h1>Carrer Don Pedro Tortajada</h1>
    <button id="guardar" class="btn btn-success">Guardar cambios</button>
    <?php if (!empty($usuariosdonpedrotortajada)) : ?>
        <div id="usuarios">
            <?php foreach ($usuariosdonpedrotortajada as $usuario): ?>
