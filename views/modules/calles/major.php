...
// Obtener los usuarios de la calle Major
$usuariosController = new UsuariosController();
$usuariosMajor = $usuariosController->obtenerUsuariosPorCalleController("major");

$orden = 1;
foreach ($usuariosMajor as &$usuario) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($data['usuariosOrdenados'])) {
        ...
        try {
            $mensaje = $usuariosController->actualizarOrdenUsuariosController($usuariosOrdenados, 'major');
...
<body>
    ...
    <h1 class="text-center" style="color: white;">Carrer Major</h1>
    ...
    <div id="usuarios" class="usuarios-container">
        ...
        <div class="usuario" data-id="<?php echo $ultimoUsuario['id']; ?>">
            <div><?php echo count($usuariosMajor); ?></div>
...
<?php else : ?>
    <p>No se encontraron usuarios registrados en la calle Major.</p>
<?php endif; ?>
