...
$usuariospoetaricardovalero = $usuariosController->obtenerUsuariosPorCalleController("poetaricardovalero");
...
<body>
    ...
    <div class="botones">
        ...
        <a href="/../views/modules/mapas/mapa-amarillo.php" class="btn btn-warning">Mapa</a>
    </div>

    <h1>Carrer Poeta Ricardo Valero</h1>
    <button id="guardar" class="btn btn-success">Guardar cambios</button>
    <?php if (!empty($usuariospoetaricardovalero)) : ?>
        <div id="usuarios">
            <?php foreach ($usuariospoetaricardovalero as $usuario): ?>
