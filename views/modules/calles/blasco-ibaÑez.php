...
// Obtener los usuarios de la calle BlascoIbanyez
$usuariosController = new UsuariosController();
$usuariosBlascoIbanyez = $usuariosController->obtenerUsuariosPorCalleController("blasco_ibanyez");

$orden = 1;
foreach ($usuariosBlascoIbanyez as &$usuario) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($data['usuariosOrdenados'])) {
        ...
        try {
            $mensaje = $usuariosController->actualizarOrdenUsuariosController($usuariosOrdenados, 'blascoibanyez');
...
<head>
    ...
    <title>Carrer Blasco Ibanyez</title>
...
<body>
    ...
    <h1 class="text-center" style="color: white;">Carrer Blasco Ibanyez</h1>
    ...
    <?php if (!empty($usuariosBlascoIbanyez)) : ?>
    <div id="usuarios" class="usuarios-container">
        <?php 
        // Obtener el último usuario
        $ultimoUsuario = end($usuariosBlascoIbanyez);
        
        // Reiniciar el puntero del array
        reset($usuariosBlascoIbanyez);
        
        // Mostrar todos los usuarios excepto el último
        for ($i = 0; $i < count($usuariosBlascoIbanyez) - 1; $i++) : 
            $usuario = $usuariosBlascoIbanyez[$i];
        ?>
        ...
        <div class="usuario" data-id="<?php echo $ultimoUsuario['id']; ?>">
            <div><?php echo count($usuariosBlascoIbanyez); ?></div>
...
<?php else : ?>
    <p>No se encontraron usuarios registrados en la calle BlascoIbanyez.</p>
<?php endif; ?>
