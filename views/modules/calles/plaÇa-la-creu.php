...
// Obtener los usuarios de la calle LaCreu
$usuariosController = new UsuariosController();
$usuariosLaCreu = $usuariosController->obtenerUsuariosPorCalleController("plaza_la_creu");

$orden = 1;
foreach ($usuariosLaCreu as &$usuario) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($data['usuariosOrdenados'])) {
        ...
        try {
            $mensaje = $usuariosController->actualizarOrdenUsuariosController($usuariosOrdenados, 'plazalacreu');
...
<body>
    ...
    <h1 class="text-center" style="color: white;">Plaça la Creu</h1>
    ...
    <div id="usuarios" class="usuarios-container">
        ...
        <div class="usuario" data-id="<?php echo $ultimoUsuario['id']; ?>">
            <div><?php echo count($usuariosLaCreu); ?></div>
...
<?php else : ?>
    <p>No se encontraron usuarios registrados en la calle LaCreu.</p>
<?php endif; ?>
...
function ordenarAutomaticamente() {
    ...
    // Orden personalizado
    const ordenPersonalizado = [5, 6, 7, 1, 2, 3, 4];
