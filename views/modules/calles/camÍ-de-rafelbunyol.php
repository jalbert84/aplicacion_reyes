...
// Obtener los usuarios de la calle CamiDeRafelbunyol
$usuariosController = new UsuariosController();
$usuariosCamiDeRafelbunyol = $usuariosController->obtenerUsuariosPorCalleController("cami_de_rafelbunyol");

$orden = 1;
foreach ($usuariosCamiDeRafelbunyol as &$usuario) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($data['usuariosOrdenados'])) {
        ...
        try {
            $mensaje = $usuariosController->actualizarOrdenUsuariosController($usuariosOrdenados, 'camiderafelbunyol');
...
<body>
    ...
    <div id="usuarios" class="usuarios-container">
        ...
        $ultimoUsuario = end($usuariosCamiDeRafelbunyol);
        
        // Reiniciar el puntero del array
        reset($usuariosCamiDeRafelbunyol);
        
        // Mostrar todos los usuarios excepto el último
        for ($i = 0; $i < count($usuariosCamiDeRafelbunyol) - 1; $i++) : 
            $usuario = $usuariosCamiDeRafelbunyol[$i];
        ?>
        ...
        <div class="usuario" data-id="<?php echo $ultimoUsuario['id']; ?>">
            <div><?php echo count($usuariosCamiDeRafelbunyol); ?></div>
...
<?php else : ?>
    <p>No se encontraron usuarios registrados en la calle CamiDeRafelbunyol.</p>
<?php endif; ?>
