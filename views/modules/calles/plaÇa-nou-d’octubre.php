...
$usuariosplazanoudoctubre = $usuariosController->obtenerUsuariosPorCalleController("plazanoudoctubre");
...
<head>
    <meta charset="UTF-8">
    <title>Plaça Nou d'octubre</title>
...
<body>
    ...
    <h1>Plaça Nou d'octubre</h1>
    <button id="guardar" class="btn btn-success">Guardar canvis</button>
    <?php if (!empty($usuariosplazanoudoctubre)) : ?>
        <div id="usuarios">
            <?php foreach ($usuariosplazanoudoctubre as $usuario): ?>
