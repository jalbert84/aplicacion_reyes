...
<head>
    ...
    <title>Llistat de Carrers</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="text-center">Llistat de carrers</h1>
        ...
        <?php
        // Llista de carrers clasificadas por color
        $calles_verde = [
            "VALENCIA",
            "PLAÇA LA CREU",
            "DOCTOR NAVARRO",
...
<div class="botones">
    <a href="/views/modules/orden/azul.php" style="background: #007BFF;">Llistat</a>
    <a href="/views/modules/orden/rojo.php" style="background: #DC3545;">Llistat</a>
    <a href="/views/modules/orden/verde.php" style="background: #28A745;">Llistat</a>
    <a href="/views/modules/orden/amarillo.php" style="background: #FFC107; color: black;">Llistat</a>
    <a href="/views/modules/orden/gris.php" style="background: #6C757D;">Llistat</a>
    <a href="/views/modules/orden/morado.php" style="background:rgb(154, 5, 184);">Llistat</a>
</div>
    </div>
</body>
</html>
